...
*-- FoxBin2Prg v1.19.38
*-------------------------------------------------------------------------------------------------------------------------------------------
#DEFINE C_ASTERISK_EXT_NOT_ALLOWED_LOC						"Die Erweiterungen * und ? sind nicht erlaubt, da sie gefährlich sind (Binaries könnten mit xx2 leeren Dateien überschrieben werden)"
#DEFINE C_BACKLINK_CANT_UPDATE_BL_LOC						"Backlink kann nicht aktualisiert werden"
#DEFINE C_BACKLINK_OF_TABLE_LOC								"von Tabelle"
#DEFINE C_BACKUP_OF_LOC										"Erzeuge Backup von: "
...
#DEFINE C_CONVERTER_UNLOAD_LOC								"Konverter wird entladen"		&&don't realy grok it even in english
#DEFINE C_CONVERTING_FILE_LOC								"Konvertiere Datei"
#DEFINE C_DATA_ERROR_CANT_PARSE_UNPAIRING_DOUBLE_QUOTES_LOC	"Datenfehler: Keine Analyse möglich, da ungepaarte Anführungszeichen in Zeile <<lcMetadatos>> sind."
...
#DEFINE C_END_OF_PROCESS_LOC								"Ende desr Prozesses"
...
#DEFINE C_EXTENSION_RECONFIGURATION_LOC						" Nneukonfiguration der Erweiterungen:"		&&wir wollen es mal nicht übertreiben, mit den zusammengesetzten Substantiven
#DEFINE C_EXTERNAL_CLASS_COUNT_DOES_NOT_MATCH_FOUND_CLASSES_LOC	"Die Anzahl externee Klassen (<< toModulo._ExternalClasses_Count >>) entspricht nicht der der gefunden Klassen (<< toModulo._Clases_Count >>), Datei: [<< toFoxBin2Prg.c_InputFile >>]"
...
#DEFINE C_FOXBIN2PRG_JUST_VFP_9_LOC							"FOXBIN2PRG arbeitet nur für Visual FoxPro 9.0!"
#DEFINE C_FOXBIN2PRG_WARN_CAPTION_LOC						"FOXBIN2PRG: WARNUNG!"
#DEFINE C_LANGUAGE_LOC										"DE"
#DEFINE C_MENU_NOT_IN_VFP9_FORMAT_LOC						"Menu [<<THIS.c_InputFile>>] ist NICHT in VFP 9 Format! - Bitte zuerst mit MODIFY MENU '<<THIS.c_InputFile>>' nach VFP 9 konvertieren."
...
#DEFINE C_OBJECT_NAME_WITHOUT_OBJECT_OREG_LOC				"Objekt [<<toObj.CLASS>>] enthält nicht das oReg Objekt (level <<TRANSFORM(tnNivel)>>)"
#DEFINE C_ONLY_SETNAME_AND_GETNAME_RECOGNIZED_LOC			"Befehl nicht erkannt. Nur SETNAME und GETNAME erlaubt."
#DEFINE C_OUTPUT_FILE_IS_NOT_OVERWRITEN_LOC					"Optimierung: Ausgabedatei [<<tcOutputFile>>] wurde nicht überschrieben, da sie dieselbe ist wie die neu generierte."
...
#DEFINE C_PROCEDURE_NOT_CLOSED_ON_LINE_LOC					"Prozcedur nicht geschlossen. Letzte Zeile des Codes muss ENDPROC sein. [<<laLineas(1)>>, Recno:<<RECNO()>>]"
...
#DEFINE C_SCANNING_FILE_AND_DIR_INFO_LOC					"Scanne Datei- und Verzeichnisinformationen für"
#DEFINE C_SOURCEFILE_LOC									"Quell Datei: "
...
#DEFINE C_WARN_TABLE_ALIAS_ON_INDEX_EXPRESSION_LOC			"WARNUNG!!" + CR_LF+ "STELLEN SIE SICHER, DAS KEIN TABELLENALIAS IM INDEXAUSDRUCK BENUTZT WIRD!! (z.B.: index on <<UPPER(JUSTSTEM(THIS.c_InputFile))>>.campo tag keyname)"
