...
user in an INI file next to WinMergePortable.exe called WinMergePortable.ini.
...
copy AppNamePortable.ini from this directory to WinMergePortable.ini next to
WinMergePortable.exe. The options in the INI file are as follows:
