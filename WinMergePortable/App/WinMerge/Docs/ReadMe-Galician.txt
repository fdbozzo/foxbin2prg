...
O WinMerge é unha ferramenta Open Source de comparación e mestura para Windows. 
O WinMerge pode comparar tanto arquivos como cartafoles, presentando as diferenzas 
nun formato de texto visual que é moi sinxelo de entender e manexar. O WinMerge 
pode empregarse como unha ferramenta externa de diferenciación/mestura ou como
unha aplicación independente.

O WinMerge ten varias funcionalidades de grande utilidade para facer comparacións, 
, sincronizar e mesturar do xeito máis doado e pragmático posible. Mesmo resalta o 
...
Axuda do WinMerge
===============
A axuda do WinMerge instalase localmente como un arquivo de axuda Microsoft HTML, 
WinMerge.chm, cando instalas o WinMerge. Para abrila, preme en Axuda>Axuda do 
WinMerge ou preme F1 na fiestra do WinMerge. Se empregas a liña de comandos, 
...
cuestións relativas ao desenrolo do WinMerge.
...
Se envía unha notificación de erro, por favor, inclúe a versión do  WinMerge na mesma. 
Podes xerar un rexistro da configuración premendo en Axuda>Configuración.
Por favor, adxunta o rexistro da configuración xerado á notificación de erro, pois ten unha 
morea de información moi útil para os desenvolvedores.
